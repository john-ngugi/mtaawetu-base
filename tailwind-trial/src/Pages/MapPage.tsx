...
console.log(no2AirQualityIndexTimeseries2024)
  ...
  return (
    <div className="flex h-screen w-screen">
      {/* Sidebar */}
      <aside
        className={`z-20 bg-indigo-600 text-white p-5 flex flex-col space-y-6 transition-transform duration-300 ${isSidebarOpen ? "w-64 md:w-64 sm:w-48 overflow-y-scroll" : "w-16"
